                    ...
                    user?.role !== 'Admin' && (
                        <Fragment>
                            ...
                            <div className='grow h-10 max-h-10 flex space-x-6 pl-12'>
                                <NavLink to='/' className={({ isActive }) => (isActive ? 'text-black underline text-2xl' : ' text-gray-400 text-2xl')}>
                                    Home
                                </NavLink>
                                <NavLink to='/view' className={({ isActive }) => (isActive ? 'text-black underline text-2xl' : ' text-gray-400 text-2xl')}>
                                    Form
                                </NavLink>
                            </div>
                        </Fragment>
